...
HD_PWD='C:/Users/RAYAN/Lab3/Lab3.runs/Lab3_slicer_A_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_slicer_A_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab3_slicer_A_0_0.tcl
