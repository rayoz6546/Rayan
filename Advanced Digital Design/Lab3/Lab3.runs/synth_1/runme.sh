...
HD_PWD='C:/Users/RAYAN/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab3_wrapper.tcl
