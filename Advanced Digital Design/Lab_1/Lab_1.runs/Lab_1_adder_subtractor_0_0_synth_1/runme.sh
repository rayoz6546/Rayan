...
HD_PWD='C:/Users/RAYAN/Lab_1/Lab_1.runs/Lab_1_adder_subtractor_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_1_adder_subtractor_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_1_adder_subtractor_0_0.tcl
