...
HD_PWD='C:/Users/RAYAN/Lab_4/Lab_4.runs/Lab_4_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_4_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_4_xbar_0.tcl
