...
void startGame(){
   ...
   if (idleBall== true){ // if the ball falls off the bottom --> start again (game over)
      arduboy.clear();
      arduboy.print("Let's Play!");
      arduboy.display();
      return;
        }
    else {  
...
void loop() {
  ...
  renderPaddle();
  // ======================
  startGame();      // call function here after value of idleBall has been updated
  arduboy.display();
}
