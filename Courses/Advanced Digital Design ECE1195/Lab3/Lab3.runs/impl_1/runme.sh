...
HD_PWD='C:/Users/RAYAN/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab3_wrapper.tcl -notrace
