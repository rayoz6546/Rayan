...
HD_PWD='C:/Users/RAYAN/Lab_4/Lab_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_4_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_4_wrapper.tcl -notrace
