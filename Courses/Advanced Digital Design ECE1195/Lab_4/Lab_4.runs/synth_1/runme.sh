...
HD_PWD='C:/Users/RAYAN/Lab_4/Lab_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_4_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_4_wrapper.tcl
